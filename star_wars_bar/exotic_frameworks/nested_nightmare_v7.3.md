...
```json
{
  ...
  "analysis_variants": {
    "default": {
      "description": "Complete nested contextual analysis with hierarchical coherence assessment and raw analysis log output.",
      "analysis_prompt": "You are an expert analyst of nested discourse contexts with deep understanding of hierarchical meaning structures across diverse analytical contexts. Your task is to analyze the provided text using the Nested Nightmare Framework v7.3, which tests the system's ability to handle deeply nested analytical structures while maintaining v7.3 compliance with enhanced metadata scoring.\\n\\nThe framework evaluates discourse across multiple nested contextual layers:\\n\\n**Primary Contextual Dimensions**: Surface Context (0.0-1.0) - immediate rhetorical content; Social Context (0.0-1.0) - community and cultural implications; Historical Context (0.0-1.0) - temporal and precedential factors; Systemic Context (0.0-1.0) - institutional and structural elements; Meta Context (0.0-1.0) - self-referential and recursive elements.\\n\\n**Secondary Coherence Dimensions**: Vertical Coherence (0.0-1.0) - alignment across context levels; Horizontal Coherence (0.0-1.0) - consistency within context levels; Recursive Coherence (0.0-1.0) - self-referential consistency.\\n\\nFor each dimension, provide:\\n- **Score (0.0-1.0)**: Based on strength of evidence in the text\\n- **Salience (0.0-1.0)**: How central is this dimension to this specific text?\\n- **Confidence (0.0-1.0)**: How certain are you in this assessment?\\n\\nWrite a comprehensive analytical report that covers:\\n- Application of the Nested Nightmare methodology to this specific text\\n- Detailed analysis of each contextual layer with scores, salience, confidence, and evidence\\n- Assessment of hierarchical coherence patterns across all nested levels\\n- Overall contextual depth profile revealing how meaning operates across multiple layers\\n- Key insights about the discourse's nested complexity and self-referential patterns\\n\\nEmbed your numerical assessments naturally within the analysis. For example: 'This text demonstrates strong surface context activity (surface context score: 0.8, salience: 0.9, confidence: 0.7) with clear immediate rhetorical content.' Focus on rigorous intellectual analysis supported by direct textual evidence and clear reasoning for all scores and metadata, maintaining coherence across all hierarchical levels."
    }
  }
}
```
