# Constitutional Health Framework (CHF) v7.3
...
*Consider related semantic expressions - focus on concepts of maintaining and improving existing constitutional framework regardless of specific reform approaches.*
...
```json
{
  ...
  "version": "v7.3",
  "display_name": "Constitutional Health Framework (CHF) v7.3",
  "analysis_variants": {
    "default": {
      "description": "Sequential constitutional health analysis with chain-of-thought methodology",
      "analysis_prompt": "You are an expert constitutional health analyst with deep understanding of democratic institutional dynamics. Analyze this text through focused sequential steps, examining each constitutional axis independently before integration.\n\nSTEP 1 - PROCEDURAL AXIS ANALYSIS\nFocus ONLY on procedural legitimacy vs. procedural rejection patterns (ignore other dimensions for now):\n- Look for procedural legitimacy markers: process language (\"constitutional process,\" \"established procedure,\" \"due process\"), norm adherence (\"following protocol,\" \"constitutional requirements\"), democratic process (\"electoral mandate,\" \"legislative process\")\n- Look for procedural rejection markers: bypass language (\"bypass the system,\" \"go around,\" \"circumvent\"), emergency rhetoric (\"emergency powers,\" \"extraordinary measures\"), process dismissal (\"broken system,\" \"failed procedures\")\n- Score procedural legitimacy dimension (0.0-1.0) with specific textual evidence\n- Score procedural rejection dimension (0.0-1.0) with specific textual evidence\n- Assess procedural legitimacy salience (0.0-1.0): How central are procedural legitimacy appeals to the overall message?\n- Assess procedural rejection salience (0.0-1.0): How central are procedural rejection appeals to the overall message?\n- State procedural legitimacy confidence (0.0-1.0): How certain are you about the procedural legitimacy score?\n- State procedural rejection confidence (0.0-1.0): How certain are you about the procedural rejection score?\nShow your analytical work and evidence before proceeding.\n\nSTEP 2 - INSTITUTIONAL AXIS ANALYSIS\nNow focus ONLY on institutional respect vs. institutional subversion patterns:\n- Look for institutional respect markers: authority recognition (\"institutional authority,\" \"expert analysis,\" \"separation of powers\"), expertise deference (\"professional judgment,\" \"institutional knowledge\"), system support (\"checks and balances,\" \"institutional integrity\")\n- Look for institutional subversion markers: authority attacks (\"corrupt institutions,\" \"illegitimate authority,\" \"failed establishment\"), expertise dismissal (\"so-called experts,\" \"institutional bias\"), system delegitimization (\"rigged system,\" \"deep state\")\n- Score institutional respect dimension (0.0-1.0) with specific textual evidence\n- Score institutional subversion dimension (0.0-1.0) with specific textual evidence\n- Assess institutional respect salience (0.0-1.0): How central are institutional respect appeals to the message?\n- Assess institutional subversion salience (0.0-1.0): How central are institutional subversion appeals to the message?\n- State institutional respect confidence (0.0-1.0): How certain are you about the institutional respect score?\n- State institutional subversion confidence (0.0-1.0): How certain are you about the institutional subversion score?\nShow your analytical work and evidence before proceeding.\n\nSTEP 3 - SYSTEMIC AXIS ANALYSIS\nNow focus ONLY on systemic continuity vs. systemic replacement patterns:\n- Look for systemic continuity markers: stability language (\"constitutional stability,\" \"democratic tradition,\" \"institutional continuity\"), improvement focus (\"strengthen institutions,\" \"reform within system\"), heritage respect (\"founding principles,\" \"constitutional wisdom\")\n- Look for systemic replacement markers: revolution rhetoric (\"new system,\" \"radical transformation,\" \"complete overhaul\"), system rejection (\"tear it down,\" \"start over\"), replacement calls (\"new constitution,\" \"different system\")\n- Score systemic continuity dimension (0.0-1.0) with specific textual evidence\n- Score systemic replacement dimension (0.0-1.0) with specific textual evidence\n- Assess systemic continuity salience (0.0-1.0): How central are systemic continuity appeals to the message?\n- Assess systemic replacement salience (0.0-1.0): How central are systemic replacement appeals to the message?\n- State systemic continuity confidence (0.0-1.0): How certain are you about the systemic continuity score?\n- State systemic replacement confidence (0.0-1.0): How certain are you about the systemic replacement score?\nShow your analytical work and evidence before proceeding.\n\nFINAL STEP - INTEGRATION AND VALIDATION\nReview your step-by-step analysis:\n- Check for scoring consistency across all constitutional axes\n- Validate that evidence quality meets academic standards\n- Identify constitutional tensions and institutional messaging patterns\n- Confirm confidence levels are appropriately calibrated\n- Calculate health scores and constitutional direction indices\n- Apply pattern classifications based on overall constitutional profile\n\nProvide your final structured analysis following this format:\n\n**CONSTITUTIONAL HEALTH ASSESSMENT**\n\n**Procedural Axis**: [procedural_legitimacy score]/[procedural_rejection score] (procedural legitimacy salience: [score], procedural rejection salience: [score], procedural legitimacy confidence: [score], procedural rejection confidence: [score])\n**Institutional Axis**: [institutional_respect score]/[institutional_subversion score] (institutional respect salience: [score], institutional subversion salience: [score], institutional respect confidence: [score], institutional subversion confidence: [score])  \n**Systemic Axis**: [systemic_continuity score]/[systemic_replacement score] (systemic continuity salience: [score], systemic replacement salience: [score], systemic continuity confidence: [score], systemic replacement confidence: [score])\n\n**Calculated Metrics**:\n- Constitutional Direction Index: [calculated score]\n- Salience-Weighted Index: [calculated score]\n- Pattern Classification: [classification]\n\n**Key Insights**: [Summary of constitutional implications, institutional patterns, and democratic health indicators]"
    }
  },
  "dimension_groups": {
  ...
  "static_weights": {
    "procedural_legitimacy": 0.20,
    "procedural_rejection": 0.20,
    "institutional_respect": 0.30,
    "institutional_subversion": 0.30,
    "systemic_continuity": 0.15,
  ...
  "calculation_spec": {
    ...
    "pattern_classifications": {
      "constitutional_health_profile": {
        "constitutional_reinforcement": {"threshold": ">=0.75", "description": "Strong support for democratic institutions and processes"},
        "mixed_constitutional_impact": {"threshold": "0.50-0.74", "description": "Balance of supportive and undermining elements"},
        "constitutional_stress": {"threshold": "0.25-0.49", "description": "Predominantly undermining with limited institutional support"},
        "constitutional_erosion": {"threshold": "<0.25", "description": "Systematic institutional delegitimization and process rejection"}
      },
      "strategic_patterns": {
  ...
  "reporting_metadata": {
    "framework_summary": "Assessment of constitutional health through institutional discourse analysis",
    "primary_dimensions": ["procedural_legitimacy", "institutional_respect", "systemic_continuity"],
    "key_metrics": ["constitutional_direction_index", "legitimacy_index", "pathology_index"],
    "bias_considerations": "Framework may favor existing institutional arrangements; requires cross-cultural validation",
    "reliability_notes": "Designed for high inter-rater consistency through sequential constitutional analysis"
  },
  "output_contract": {
    "raw_analysis_log_structure": {
      "step_1_procedural": "Procedural legitimacy vs. rejection analysis with scores, salience, confidence, and evidence",
      "step_2_institutional": "Institutional respect vs. subversion analysis with scores, salience, confidence, and evidence", 
      "step_3_systemic": "Systemic continuity vs. replacement analysis with scores, salience, confidence, and evidence",
      "final_integration": "Calculated health scores, pattern classifications, and constitutional assessment"
    },
    "instructions": "Follow the sequential analysis format exactly. Each step must include specific textual evidence, numerical scores (0.0-1.0), salience assessment, and confidence rating. Final integration must calculate all health scores and apply pattern classifications."
  },
  "reliability_rubric": {
    "cronbachs_alpha": {
      "excellent": [0.80, 1.0],
