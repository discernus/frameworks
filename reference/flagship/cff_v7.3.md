# Cohesive Flourishing Framework (CFF) v7.3
...
The framework evaluates political discourse across five bipolar axes that form the foundation of social cohesion:
...
**Dynamic Salience Weighting**: Each dimension receives a salience weight (0.0-1.0) based on its centrality to the specific text being analyzed. This allows the framework to adapt to different types of political discourse while maintaining analytical rigor. The salience weighting enables distinction between texts with similar dimension scores but fundamentally different rhetorical strategies.
...
```json
{
  "name": "cohesive_flourishing_framework",
  "version": "v7.3",
  "display_name": "Cohesive Flourishing Framework (CFF) v7.3",
  "analysis_variants": {
    "default": {
      "description": "Sequential social cohesion analysis with chain-of-thought methodology and tension mathematics",
      "analysis_prompt": "You are an expert discourse analyst specializing in social cohesion and rhetorical strategy analysis. Analyze this text through focused sequential steps, examining each dimension group independently before integration.\n\nSTEP 1 - IDENTITY AXIS ANALYSIS\nFocus ONLY on tribal dominance vs. individual dignity patterns (ignore other dimensions for now):\n- Look for tribal dominance patterns: in-group supremacy (\"our people first,\" \"real Americans\"), exclusionary framing (\"us vs them,\" \"outsiders\"), superiority claims (\"better than,\" \"more deserving\") - Note: These are semantic concepts, look for group supremacy and exclusionary identity, not just these exact words\n- Look for individual dignity patterns: universal worth (\"all people,\" \"human dignity\"), inclusive language (\"regardless of,\" \"common humanity\"), individual agency (\"personal responsibility,\" \"human potential\") - Note: These are semantic concepts, look for universal human worth and inclusive recognition, not just these exact terms\n- Score tribal dominance dimension (0.0-1.0) with specific textual evidence\n- Score individual dignity dimension (0.0-1.0) with specific textual evidence\n- Assess salience (0.0-1.0): How central are identity appeals to the overall message?\n- State confidence (0.0-1.0): How certain are you in this assessment?\nShow your analytical work and evidence before proceeding.\n\nSTEP 2 - EMOTIONAL CLIMATE AXIS ANALYSIS\nNow focus ONLY on fear vs. hope patterns:\n- Look for fear patterns: crisis language (\"emergency,\" \"crisis,\" \"catastrophe\"), threat emphasis (\"under attack,\" \"in danger\"), vulnerability framing (\"defenseless,\" \"exposed\") - Note: These are semantic concepts, look for language creating anxiety and crisis mentality, not just these exact words\n- Look for hope patterns: progress language (\"moving forward,\" \"bright future\"), opportunity emphasis (\"opportunity,\" \"potential\"), optimistic vision (\"we can,\" \"achievable\") - Note: These are semantic concepts, look for language creating optimism and possibility, not just these exact expressions\n- Score fear dimension (0.0-1.0) with specific textual evidence\n- Score hope dimension (0.0-1.0) with specific textual evidence\n- Assess salience (0.0-1.0): How central are emotional climate appeals to the message?\n- State confidence (0.0-1.0): How certain are you in this assessment?\nShow your analytical work and evidence before proceeding.\n\nSTEP 3 - SUCCESS ORIENTATION AXIS ANALYSIS\nNow focus ONLY on envy vs. compersion patterns:\n- Look for envy patterns: resentment language (\"unfair advantage,\" \"privileged elite\"), zero-sum framing (\"their gain, our loss,\" \"limited resources\"), grievance emphasis (\"left behind,\" \"deserve better\") - Note: These are semantic concepts, look for resentment toward others' success and zero-sum thinking, not just these exact phrases\n- Look for compersion patterns: celebration language (\"congratulations,\" \"well-deserved\"), merit recognition (\"earned success,\" \"hard work pays off\"), supportive framing (\"happy for,\" \"inspired by\") - Note: These are semantic concepts, look for celebrating others' success and abundance mindset, not just these exact expressions\n- Score envy dimension (0.0-1.0) with specific textual evidence\n- Score compersion dimension (0.0-1.0) with specific textual evidence\n- Assess salience (0.0-1.0): How central are success orientation appeals to the message?\n- State confidence (0.0-1.0): How certain are you in this assessment?\nShow your analytical work and evidence before proceeding.\n\nSTEP 4 - RELATIONAL CLIMATE AXIS ANALYSIS\nNow focus ONLY on enmity vs. amity patterns:\n- Look for enmity patterns: hostility language (\"enemy,\" \"opponent,\" \"fight against\"), antagonistic framing (\"battle,\" \"war,\" \"defeat\"), demonization patterns (\"evil,\" \"corrupt,\" \"dangerous\") - Note: These are semantic concepts, look for hostility and adversarial positioning, not just these exact terms\n- Look for amity patterns: cooperative language (\"together,\" \"partnership,\" \"collaboration\"), friendship appeals (\"friends,\" \"allies,\" \"solidarity\"), shared interest recognition (\"common ground,\" \"mutual benefit\") - Note: These are semantic concepts, look for cooperation and shared interests, not just these exact words\n- Score enmity dimension (0.0-1.0) with specific textual evidence\n- Score amity dimension (0.0-1.0) with specific textual evidence\n- Assess salience (0.0-1.0): How central are relational climate appeals to the message?\n- State confidence (0.0-1.0): How certain are you in this assessment?\nShow your analytical work and evidence before proceeding.\n\nSTEP 5 - GOAL ORIENTATION AXIS ANALYSIS\nNow focus ONLY on fragmentative vs. cohesive goals patterns:\n- Look for fragmentative goals patterns: divisive objectives (\"separate,\" \"divide,\" \"break apart\"), zero-sum competition (\"winner takes all,\" \"defeat them\"), destructive aims (\"destroy,\" \"eliminate,\" \"crush\") - Note: These are semantic concepts, look for division and destructive objectives, not just these exact methods\n- Look for cohesive goals patterns: integrative objectives (\"bring together,\" \"unite,\" \"build\"), collaborative aims (\"work together,\" \"joint effort,\" \"shared success\"), constructive vision (\"improve,\" \"enhance,\" \"flourish\") - Note: These are semantic concepts, look for unity and integrative objectives, not just these exact projects\n- Score fragmentative goals dimension (0.0-1.0) with specific textual evidence\n- Score cohesive goals dimension (0.0-1.0) with specific textual evidence\n- Assess salience (0.0-1.0): How central are goal orientation appeals to the message?\n- State confidence (0.0-1.0): How certain are you in this assessment?\nShow your analytical work and evidence before proceeding.\n\nFINAL STEP - INTEGRATION AND VALIDATION\nReview your step-by-step analysis:\n- Check for scoring consistency across all dimension groups\n- Validate that evidence quality meets academic standards\n- Calculate tension scores using formula: min(Dim_A, Dim_B) × |Salience_A - Salience_B|\n- Confirm confidence levels are appropriately calibrated\n- Calculate Strategic Contradiction Index and cohesion indices\n- Apply pattern classifications based on overall social cohesion profile\n\nProvide your final structured analysis following this format:\n\n**SOCIAL COHESION ASSESSMENT**\n\n**Identity Axis**: [tribal_dominance score]/[individual_dignity score] (salience: [score], confidence: [score])\n**Emotional Climate Axis**: [fear score]/[hope score] (salience: [score], confidence: [score])  \n**Success Orientation Axis**: [envy score]/[compersion score] (salience: [score], confidence: [score])\n**Relational Climate Axis**: [enmity score]/[amity score] (salience: [score], confidence: [score])\n**Goal Orientation Axis**: [fragmentative_goals score]/[cohesive_goals score] (salience: [score], confidence: [score])\n\n**Calculated Metrics**:\n- Strategic Contradiction Index: [calculated score]\n- Overall Cohesion Index: [calculated score]\n- Pattern Classification: [classification]\n\n**Key Insights**: [Summary of social cohesion patterns, rhetorical tensions, and democratic implications]"
    }
  },
  "dimension_groups": {
  ...
  "reporting_metadata": {
    "framework_summary": "Comprehensive assessment of social cohesion and democratic resilience through discourse analysis",
    "primary_dimensions": ["tribal_dominance", "individual_dignity", "fear", "hope", "envy", "compersion", "enmity", "amity", "fragmentative_goals", "cohesive_goals"],
    "key_metrics": ["strategic_contradiction_index", "overall_cohesion_index", "cohesive_index", "fragmentative_index"],
    "bias_considerations": "Framework developed within Western democratic context; requires cross-cultural validation and ideological balance",
    "reliability_notes": "Designed for high inter-rater consistency through sequential analysis and explicit tension quantification"
  },
  "output_contract": {
    "raw_analysis_log_structure": {
      "step_1_identity": "Tribal dominance vs. individual dignity analysis with scores, salience, confidence, and evidence",
      "step_2_emotional": "Fear vs. hope analysis with scores, salience, confidence, and evidence", 
      "step_3_success": "Envy vs. compersion analysis with scores, salience, confidence, and evidence",
      "step_4_relational": "Enmity vs. amity analysis with scores, salience, confidence, and evidence",
      "step_5_goals": "Fragmentative vs. cohesive goals analysis with scores, salience, confidence, and evidence",
      "final_integration": "Calculated tension scores, strategic contradiction index, and social cohesion assessment"
    },
